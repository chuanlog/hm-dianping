...
create table hmdp.tb_blog_comments
(
    id          bigint unsigned auto_increment comment '主键'
        primary key,
    user_id     bigint unsigned                     not null comment '用户id',
...
create table hmdp.tb_seckill_voucher
(
...
create index foreign_key_type
    on hmdp.tb_shop (type_id);

create table hmdp.tb_shop_type
(
    id          bigint unsigned auto_increment comment '主键'
        primary key,
...
create table hmdp.tb_user_info
(
...
create table hmdp.tb_voucher_order
(
